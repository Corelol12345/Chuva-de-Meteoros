...
while True:
    ...
    if opcao == "1":
        ...
        # Atualiza a posição da propriedade
        ...
        while True:
            ...
            angulo = float(valores[1])  # ângulo está em graus
        ...
        # contadores para cada quadrante
        ...
        for registro in registros_meteoritos:
            ...
            # Verifique se o quadrante é válido
        ...
        # estatísticas para cada quadrante
